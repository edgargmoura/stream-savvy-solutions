        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-gray-300 mb-4">
              Leading the future of environmental engineering with innovative and sustainable solutions for water treatment and sanitation systems.
            </p>
